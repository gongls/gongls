...
var about = Vue.extend({
    ...
    '<div class="container"><div class="row"><div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">'+
    '<h3>本站使用如下技术</h3><p>服务器：ubuntu server </p><p>基于 on node.js 技术构建  </p> <p>使用了如下技术：        </p><p>1) 后端框架：express</p><p> 2) 数据库：mongodb </p>       <p>3) 模板引擎：pug ( 原名jade )         </p><p>4) 前端路由：vue-router     </p><p>5) 前端框架：vue.js / jquery.js</p><p>6) UI/style：bootstrap / bootstrap-material-design</p><p><a href="http://www.toutiao.com/m6379685251/" target="_blank">广告：米衙专栏</a></p><p>新浪微博 @张玛妮</p>'+
    '</div></div></div>',
    data:function(){
      return {
        name:'about'
